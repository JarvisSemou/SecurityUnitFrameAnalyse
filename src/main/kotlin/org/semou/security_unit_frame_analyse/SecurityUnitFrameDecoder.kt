...
//                0xFE81->parse_FE81_DataDomain(frame,resultList)
        ...
        private fun parse_0684_DataDomain(frame: String, resultList: MutableList<HashMap<ResultType, String>>) {
            val map_1 = hashMapOf<ResultType, String>(ResultType.Meaning to "数据明文")

            val data_1 = frame.substring(dataDomainCharStartIndex, dataDomainCharEndIndex)
            val (data_1_1, data_1_2) = data_1.parse_2_N_HexData()
            map_1.append(
                dataDomainByteLength,
                ResultType.Origin to """
                    $data_1_1
                    $data_1_2
                """.trimIndent(),
                ResultType.Analyzed to """
                    长度：${data_1_1.parseHexAsDecInt()}
                    数据明文：${data_1_2}
                """.trimIndent()
            ) { _, _, _, _, _, preDes ->
                preDes + """
        ...
        private fun parse_0683_DataDomain(frame: String, resultList: MutableList<HashMap<ResultType, String>>) {
            val map_1 = hashMapOf<ResultType, String>(ResultType.Meaning to "数据密文")
        ...
        private fun parse_0681_DataDomain(frame: String, resultList: MutableList<HashMap<ResultType, String>>) {
            val map_1 = hashMapOf<ResultType, String>(ResultType.Meaning to "Session Data 1")
            val map_2 = hashMapOf<ResultType, String>(ResultType.Meaning to "MAC 1")
        ...
        private fun parse_0606_DataDomain(frame: String, resultList: MutableList<HashMap<ResultType, String>>) {
            val map_1 = hashMapOf<ResultType, String>(ResultType.Meaning to "外设类型")
            val map_2 = hashMapOf<ResultType, String>(ResultType.Meaning to "数据密文")

            val data_1_byteLength = 1
            val data_2_byteLength = dataDomainByteLength
        ...
        private fun parse_0605_DataDomain(frame: String, resultList: MutableList<HashMap<ResultType, String>>) {
            val map_1 = hashMapOf<ResultType, String>(ResultType.Meaning to "外设类型")
            val map_2 = hashMapOf<ResultType, String>(ResultType.Meaning to "数据内容")
        ...
        private fun parse_0604_DataDomain(frame: String, resultList: MutableList<HashMap<ResultType, String>>) {
            val map_1 = hashMapOf<ResultType, String>(ResultType.Meaning to "外设类型")
            val map_2 = hashMapOf<ResultType, String>(ResultType.Meaning to "数据密文")
        ...
        private fun parse_0603_DataDomain(frame: String, resultList: MutableList<HashMap<ResultType, String>>) {
            val map_1 = hashMapOf<ResultType, String>(ResultType.Meaning to "外设类型")
            val map_2 = hashMapOf<ResultType, String>(ResultType.Meaning to "数据内容")
        ...
        private fun parse_0602_DataDomain(frame: String, resultList: MutableList<HashMap<ResultType, String>>) {
            val map_1 = hashMapOf<ResultType, String>(ResultType.Meaning to "密钥 KID")
            val map_2 = hashMapOf<ResultType, String>(ResultType.Meaning to "W-ESAM 芯片序列号")
            val map_3 = hashMapOf<ResultType, String>(ResultType.Meaning to "Session Data 2")
            val map_4 = hashMapOf<ResultType, String>(ResultType.Meaning to "MAC 2")
        ...
        private fun parse_0601_DataDomain(frame: String, resultList: MutableList<HashMap<ResultType, String>>) {
            val map_1 = hashMapOf<ResultType, String>(ResultType.Meaning to "密钥 KID")
            val map_2 = hashMapOf<ResultType, String>(ResultType.Meaning to "W-ESAM 芯片序列号")
        ...
        private fun parse_0584_DataDomain(frame: String, resultList: MutableList<HashMap<ResultType, String>>) {
            val map_1 = hashMapOf<ResultType, String>(ResultType.Meaning to "数据")

            val data_1_byteLength = dataDomainByteLength
        ...
        private fun parse_0581_DataDomain(frame: String, resultList: MutableList<HashMap<ResultType, String>>) {
            val map_1 = hashMapOf<ResultType, String>(ResultType.Meaning to "Token 1")
        ...
        private fun parse_0504_DataDomain(frame: String, resultList: MutableList<HashMap<ResultType, String>>) {
            val map_1 = hashMapOf<ResultType, String>(ResultType.Meaning to "UID")
            val map_2 = hashMapOf<ResultType, String>(ResultType.Meaning to "数据长度")
            ...
            val data_1 = frame.substring(dataDomainCharStartIndex, data_2_offset)
            val (data_2, data_3) = frame.substring(data_2_offset, dataDomainCharEndIndex).parse_2_N_HexData()
        ...
        private fun parse_0503_DataDomain(frame: String, resultList: MutableList<HashMap<ResultType, String>>) {
            val map_1 = hashMapOf<ResultType, String>(ResultType.Meaning to "区位标志")
            val map_2 = hashMapOf<ResultType, String>(ResultType.Meaning to "UID")
            val map_3 = hashMapOf<ResultType, String>(ResultType.Meaning to "数据长度")
            val map_4 = hashMapOf<ResultType, String>(ResultType.Meaning to "数据")
            val map_5 = hashMapOf<ResultType, String>(ResultType.Meaning to "MAC")
            val map_6 = hashMapOf<ResultType, String>(ResultType.Meaning to "K 长度")
            val map_7 = hashMapOf<ResultType, String>(ResultType.Meaning to "K")
            val map_8 = hashMapOf<ResultType, String>(ResultType.Meaning to "时间")
            ...
            val data_3_offset = data_2_byteLength + data_2_byteLength * 2
            val data_4_offset = data_3_offset + data_3_byteLength * 2
        ...
        private fun parse_0502_DataDomain(frame: String, resultList: MutableList<HashMap<ResultType, String>>) {
            val map_1 = hashMapOf<ResultType, String>(ResultType.Meaning to "Token 2")
        ...
        private fun parse_0501_DataDomain(frame: String, resultList: MutableList<HashMap<ResultType, String>>) {
            val map_1 = hashMapOf<ResultType, String>(ResultType.Meaning to "长度")
            val map_2 = hashMapOf<ResultType, String>(ResultType.Meaning to "K0 + K1")
            val map_3 = hashMapOf<ResultType, String>(ResultType.Meaning to "UID")
            val map_4 = hashMapOf<ResultType, String>(ResultType.Meaning to "随机数")
            val map_5 = hashMapOf<ResultType, String>(ResultType.Meaning to "时间")

            val data_1_byteLength = 1
            val data_3_byteLength = 1
            val data_4_byteLength = 1
            val data_5_byteLength = 1
            val data_2_byteLength = dataDomainByteLength - (data_1_byteLength + data_3_byteLength +
                    data_4_byteLength + data_5_byteLength)
        ...
        private fun parse_048A_DataDomain(frame: String, resultList: MutableList<HashMap<ResultType, String>>) {
            parse_0488_DataDomain(frame, resultList)
        }

        private fun parse_0489_DataDomain(frame: String, resultList: MutableList<HashMap<ResultType, String>>) {
            val map_1 = hashMapOf<ResultType, String>(ResultType.Meaning to "状态字明文")
        ...
        private fun parse_0488_DataDomain(frame: String, resultList: MutableList<HashMap<ResultType, String>>) {
            val map_1 = hashMapOf<ResultType, String>(ResultType.Meaning to "密文")
        ...
        private fun parse_0487_DataDomain(frame: String, resultList: MutableList<HashMap<ResultType, String>>) {
            parse_0483_DataDomain(frame, resultList)
        }

        private fun parse_0485_DataDomain(frame: String, resultList: MutableList<HashMap<ResultType, String>>) {
            val map_1 = hashMapOf<ResultType, String>(ResultType.Meaning to "Token 1")
        ...
        private fun parse_0484_DataDomain(frame: String, resultList: MutableList<HashMap<ResultType, String>>) {
            val map_1 = hashMapOf<ResultType, String>(ResultType.Meaning to "数据")
        ...
        private fun parse_0483_DataDomain(frame: String, resultList: MutableList<HashMap<ResultType, String>>) {
            val map_1 = hashMapOf<ResultType, String>(ResultType.Meaning to "密文")
        ...
        private fun parse_0481_DataDomain(frame: String, resultList: MutableList<HashMap<ResultType, String>>) {
            val map_1 = hashMapOf<ResultType, String>(ResultType.Meaning to "Token 1")
        ...
        private fun parse_040A_DataDomain(frame: String, resultList: MutableList<HashMap<ResultType, String>>) {
            ...
            val map_3 = hashMapOf<ResultType, String>(ResultType.Meaning to "时间")
            val map_4 = hashMapOf<ResultType, String>(ResultType.Meaning to "操作权限")
        ...
        private fun parse_0409_DataDomain(frame: String, resultList: MutableList<HashMap<ResultType, String>>) {
            val map_1 = hashMapOf<ResultType, String>(ResultType.Meaning to "分散因子")
            val map_2 = hashMapOf<ResultType, String>(ResultType.Meaning to "状态字密文")
            val map_3 = hashMapOf<ResultType, String>(ResultType.Meaning to "时间")
            val map_4 = hashMapOf<ResultType, String>(ResultType.Meaning to "操作权限")
        ...
        private fun parse_0408_DataDomain(frame: String, resultList: MutableList<HashMap<ResultType, String>>) {
            val map_1 = hashMapOf<ResultType, String>(ResultType.Meaning to "分散因子")
            val map_2 = hashMapOf<ResultType, String>(ResultType.Meaning to "数据")
            val map_3 = hashMapOf<ResultType, String>(ResultType.Meaning to "时间")
            val map_4 = hashMapOf<ResultType, String>(ResultType.Meaning to "操作权限")
        ...
        private fun parse_0407_DataDomain(frame: String, resultList: MutableList<HashMap<ResultType, String>>) {
            val map_1 = hashMapOf<ResultType, String>(ResultType.Meaning to "分散因子")
            val map_2 = hashMapOf<ResultType, String>(ResultType.Meaning to "数据地址")
            val map_3 = hashMapOf<ResultType, String>(ResultType.Meaning to "时间")
            val map_4 = hashMapOf<ResultType, String>(ResultType.Meaning to "操作权限")
        ...
        private fun parse_0406_DataDomain(frame: String, resultList: MutableList<HashMap<ResultType, String>>) {
            val map_1 = hashMapOf<ResultType, String>(ResultType.Meaning to "分散因子")
        ...
        private fun parse_0405_DataDomain(frame: String, resultList: MutableList<HashMap<ResultType, String>>) {
            val map_1 = hashMapOf<ResultType, String>(ResultType.Meaning to "分散因子")
            val map_2 = hashMapOf<ResultType, String>(ResultType.Meaning to "随机数")
            val map_3 = hashMapOf<ResultType, String>(ResultType.Meaning to "时间")
            val map_4 = hashMapOf<ResultType, String>(ResultType.Meaning to "操作权限")
        ...
        private fun parse_0404_DataDomain(frame: String, resultList: MutableList<HashMap<ResultType, String>>) {
            val map_1 = hashMapOf<ResultType, String>(ResultType.Meaning to "密钥 ID")
            val map_2 = hashMapOf<ResultType, String>(ResultType.Meaning to "分散因子")
            val map_3 = hashMapOf<ResultType, String>(ResultType.Meaning to "数据")
        ...
        private fun parse_0403_DataDomain(frame: String, resultList: MutableList<HashMap<ResultType, String>>) {
            val map_1 = hashMapOf<ResultType, String>(ResultType.Meaning to "密钥 ID")
            val map_2 = hashMapOf<ResultType, String>(ResultType.Meaning to "分散因子")
            val map_3 = hashMapOf<ResultType, String>(ResultType.Meaning to "数据")
        ...
        private fun parse_0402_DataDomain(frame: String, resultList: MutableList<HashMap<ResultType, String>>) {
            val map_1 = hashMapOf<ResultType, String>(ResultType.Meaning to "密钥 ID")
            val map_2 = hashMapOf<ResultType, String>(ResultType.Meaning to "分散因子")
            val map_3 = hashMapOf<ResultType, String>(ResultType.Meaning to "Token 2")
        ...
        private fun parse_0401_DataDomain(frame: String, resultList: MutableList<HashMap<ResultType, String>>) {
            val map_1 = hashMapOf<ResultType, String>(ResultType.Meaning to "密钥 ID")
            val map_2 = hashMapOf<ResultType, String>(ResultType.Meaning to "分散因子")
            val map_3 = hashMapOf<ResultType, String>(ResultType.Meaning to "随机数")
